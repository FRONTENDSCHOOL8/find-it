...
const Navigation = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-1/2 flex h-80px w-375px -translate-x-1/2 transform items-center justify-center gap-25px rounded-tl-16px rounded-tr-16px bg-white"
    >
